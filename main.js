...
var AppComponent = /** @class */ (function () {
    function AppComponent(dataService, toastr) {
        this.dataService = dataService;
        this.toastr = toastr;
        this.title = 'crestDataNotification';
    }
    AppComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.dataService.getInvitationData().subscribe(function (data) {
            _this.dataSrc = data.invites;
        });
        setTimeout(function () {
            _this.dataService.getUpdatedInvitationData().subscribe(function (data) {
                _this.dataSrc.map(function (element, index, obj) {
                    data.invites.forEach(function (newData, i, db) {
                ...
                _this.dataSrc = _this.dataSrc.concat(data.invites);
                _this.toastr.success('Invitation Updated!');
            });
        }, 3000);
    };
    AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_data_service__WEBPACK_IMPORTED_MODULE_2__["DataService"], ngx_toastr__WEBPACK_IMPORTED_MODULE_3__["ToastrService"]])
    ], AppComponent);
    return AppComponent;
}());
...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.getInvitationData = function () {
        return this.http.get('assets/invitations.json');
    };
    DataService.prototype.getUpdatedInvitationData = function () {
...
module.exports = __webpack_require__(/*! E:\Test\CrestData\crestDataNotification\src\main.ts */"./src/main.ts");
